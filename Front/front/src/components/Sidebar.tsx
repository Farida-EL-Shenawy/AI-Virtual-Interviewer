...
import InterviewAccess from '@/components/InterviewAccess';
...
export default function Sidebar({ role }: SidebarProps) {
  ...
  const candidateMenuItems: MenuItem[] = [
    ...
    {
      name: 'Applications',
      href: '/profile/candidate/applications',
      icon: ({ className }) => (
        <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  const companyMenuItems: MenuItem[] = [
    ...
    },
    {
      ...
      href: '/profile/company/applicants',
      icon: ({ className }) => (
        <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      href: '/profile/company/analytics',
      icon: ({ className }) => (
        <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  const menuItems = role === 'candidate' ? candidateMenuItems : companyMenuItems;

  return (
    <div
      className={`fixed left-0 top-0 h-screen bg-gradient-to-b from-gray-900 to-black border-r border-gray-700 transition-all duration-300 ${isCollapsed ? 'w-16' : 'w-64'} z-50`}
    >
